/* -*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-
!!! Analyze particles function can be repeatedly run, shoul
-Watershed segmentation particles iterations: how many rounds until no new particle produced?
- SI fig. 4 Compare watershed and particle size:

Rolling Ball BG subtraction radius [15, 50, 75]
Watershed [no watershed, 1 watershed, 2 watershed]
[50, 100, 150 px particle area limit]

Particle settings 1 : radius=15, watershed = x2, area = 50

Process is 
Background Subtraction
Intensity Thesshold -> Binary Mask
Watershed
